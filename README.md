...
Каждая игра существует в двух версиях — **до** (выполненная в рамках учебного курса) и **после** (с небольшими косметическими изменениями) рефакторинга. Сравнивая их, наглядно видно, зачем нужны классы, инкапсуляция и разделение ответственности.
...
<p align="center">
  <img src="screenshots/flappy_bird.gif" width="360" alt="Геймплей Flappy Bird: жёлтая птица летит между зелёными трубами на фоне облаков"><br>
  <sub>геймплей: прыжок пробелом, счёт за каждую пройденную трубу</sub>
</p>
<p align="center">
  <img src="screenshots/flappy_bird.png" width="360" alt="Стартовый экран Flappy Bird: заголовок и подсказка «Нажмите ПРОБЕЛ для старта» на фоне градиентного неба с облаками"><br>
  <sub>стартовый экран: заголовок и подсказка</sub>
</p>
